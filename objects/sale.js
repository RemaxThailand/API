		...
		if (data.action == 'saleInfo'){
			...
			if (typeof req.body.shop != 'undefined' && req.body.shop != '' &&
				...
				typeof req.body.saledate != 'undefined' && req.body.saledate != '') {
					data.json.return = false;
					data.json.returnResult = true;
					data.command = 'EXEC sp_Pos_SellHeaderInsert \''+req.body.shop+'\',\''+req.body.saleno+'\',\''+req.body.profit+'\',\''+req.body.totalPrice+'\',\''+req.body.payType+'\',\''+req.body.cash+'\',\''+req.body.credit+'\',\''+req.body.customer+'\',\''+req.body.sex+'\',\''+req.body.age+'\',\''+req.body.saledate+'\',\''+req.body.saleby+'\',\''+req.body.comment+'\'';
